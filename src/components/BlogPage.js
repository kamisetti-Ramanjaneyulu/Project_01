...
const BlogPage = () => {
  ...
  const staticPosts = [
    {
      title: 'How to Become an Artificial Intelligence / Data Science Expert',
      date: '16-Oct-2023',
    ...
    {
      title: 'Why Use Artificial Intelligence (AI)',
      date: '16-Oct-2023',
          ...
          <div className="flex flex-col md:flex-row items-center justify-between h-full">
            <div className="p-10 md:w-1/3 flex flex-col justify-center h-full order-2 md:order-1">
              ...
              <Link
                onClick={scrollToTop}
                to="/blog/genai"
                className="mt-8 mt-6 w-32 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
              >
                Read More
              </Link>
            </div>
            <div className="block md:hidden md:w-full h-2/3 order-1 md:order-2">
              <img src={bg1} alt="AI and Planet" className="w-full h-full object-cover" />
            </div>
